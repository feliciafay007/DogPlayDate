...
public class DogProfile2 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* final int NOTIF_ID = 1234;
        ...
        query.whereEqualTo("dogNumber", 2);
        query.findInBackground(new FindCallback<ParseObject>() {
            public void done(List<ParseObject> scoreList, ParseException e) {
                if (scoreList.size()!=0) {
                    ...
                    saveButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Toast.makeText(DogProfile2.this, "Profile Uploaded",
        ...
        upLoadButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent albumIntent = new Intent(DogProfile2.this, DogAlbum.class);
                albumIntent.putExtra("userName", user);
                albumIntent.putExtra("dogNumber", 2);
        ...
        albumButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent uploadIntent = new Intent(DogProfile2.this, DogAlbum2.class);
                uploadIntent.putExtra("userName", user);
                uploadIntent.putExtra("dogNumber", 2);
